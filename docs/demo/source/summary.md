...
- **storage.expansion / demo-block**: supported (declared; snapshot; coverage: partial). StorageClass allows volume expansion.
...
| Platform | - |
| Status | ACTIVE |
| ARN | arn:aws:eks:eu-west-1:000000000000:cluster/source-demo |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| demo-workers | 1.34 | - | ACTIVE | - | m7i.large | desired=1 min=1 max=3 | - | - | - |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| demo-workers | managed-nodegroup | - | 1.34 | - | - | - | demo-node | v1.34.0 | - | containerd://2.0.0 | - | observed: runtime evidence linked to managed nodegroup |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| demo-node | - | True | true | v1.34.0 | containerd://2.0.0 | - | - | - | cpu=2,memory=8Gi,pods=29 | cpu=1900m,memory=7Gi,pods=29 | - | eks.amazonaws.com/nodegroup=demo-workers | - |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| StorageClass | demo-block | - | - | - | - | ebs.csi.aws.com | binding=WaitForFirstConsumer reclaim=Retain expand=true |
...
| Node | demo-node | containerd://2.0.0 | v1.34.0 | -/- | - |
